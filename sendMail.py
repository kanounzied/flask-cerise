...
def sendPDF(receiver_mail,pdf, text, type):
    ...
    sender_mail = "artzy.proj@gmail.com"
    # receiver_mail = "zied.kanoun6@gmail.com"
    subject = "contrat assurence "+type
...
def sendPDFc(receiver_mail,pdf, text):
    ...
    sender_mail = "artzy.proj@gmail.com"
    # receiver_mail = "zied.kanoun6@gmail.com"
    subject = "Constat d'accident automobile"
    ...
    <html>
        <body style='color: black;'>
            <h1>Hello , the accident report is here! </h1><br>
            <p>"""+text+"""</p>
            <p>    </p>
        </body>
    </html>
    ...
    part.add_header(
        "Content-Disposition",
        f"attachment; filename= {'constat.pdf'}",
    )
...
=======
        print('connected!')
>>>>>>> 2576d99ed20d65c20b1c88b868c36e52059dbe99
        server.sendmail(sender_mail, receiver_mail, message.as_string())
        print('message sent!')
